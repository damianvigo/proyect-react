...
class Peliculas extends Component {
  ...
  componentWillMount() {
    ...
    this.setState({
      peliculas: [
        ...
        {
          titulo: 'Gladiador',
          image: 'https://4.bp.blogspot.com/-UJySjzoeoZI/TcFtUYQyNhI/AAAAAAAAACc/xkE6mf9F-9o/s1600/gladiator01800.jpg',
        },
      ],
      nombre: 'Damian Vigo',
      favorita: {},
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Slider title='Peliculas' /* prop title */ size='slider-small' />
        ...
        <div className='center'>
          <div id='content' className='peliculas'>
            ...
            <div>
              <p>
                <button onClick={this.cambiarTitulo}> Cambiar titulo de Gladiador </button>{' '}
              </p>
            </div>
            ...
            <div id='articles' className='peliculas'>
              {this.state.peliculas.map((pelicula, i) => {
                return <Pelicula key={i} pelicula={pelicula} marcarFavorita={this.favorita} indice={i} />;
              })}
            </div>
          </div>
