...
class Articles extends Component {
  ...
  state = { // guardando datos del api en el state
    articles: [],
    status: null
  };

  componentWillMount() { // metodo de ciclo de vida, antes de que se cargue la vista, cargar todos los articulos del api
