...
class EditArticle extends Component {
  ...
  getArticle = (id) => { // pasando el id del articulo para sacar
  ...
  saveArticle = (e) => {
    ...
    axios.put(this.url+'/article/'+this.articleId, this.state.article) /* este es el objeto que se encuentra en el state y se guarda en la base de datos */
         .then(res => {
           if(res.data.article){
            ...
            // Subir la imagen
            if(this.state.selectedFile !== null) { /* si es diferente a null, subir el archivo a la base de datos */
              ...
              formData.append( /* metodo append vincularle un fichero */
                'file0',
      ...
      <div className="center">
        <section id="content">
          ...
          {this.state.article.title && 
            ...
            <form className="mid-form" onSubmit={this.saveArticle} > {/* metodo que se llama cuando se enviar el form */}
            ...
            <div className="form-group">
              ...
              {this.validator.message('title', this.state.article.title, 'required|alpha')} {/* 3 parametros del message. // alphanumericos */}
